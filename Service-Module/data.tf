...
data "aws_iam_policy_document" "ecs_module_managed_execution_role_policy" {
  ...
  statement {
      ...
      resources = [
        local.ecr_repository_name.arn         #aws_ecr_repository.this[0].arn
      ]
  }
}
...
data "aws_ecr_repository" "ecr_repo" {
  name = "609258630391.dkr.ecr.eu-west-1.amazonaws.com/pite-dldeb${var.env}-${var.service_name}-ecr-repo"
}
