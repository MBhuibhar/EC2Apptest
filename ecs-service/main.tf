...
module "pite-dldeb_services_SQL_service" {
  ...
  task_role_policy           = module.service-Module.aws_iam_role.iam_role_ecs_terraform
  task_execution_role_policy = module.service-Module.aws_iam_role.iam_role_ecs_terraform
...
module "pite-dldeb_services_MYSQL_service" {
  ...
  task_role_policy           = aws_iam_role.iam_role_ecs_terraform.id
  task_execution_role_policy = aws_iam_role.iam_role_ecs_terraform.id
  container_traffic_protocol = "tcp"
  account_id                 = "var.account_id"
  ecr_repo                   = "var.ecr_repo"
  iam_role                   = "var.iam_role"
