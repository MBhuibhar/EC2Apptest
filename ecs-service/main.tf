...
module "pite-dldeb_services_SQL_service" {
  ...
  task_role_policy               = module.aws_iam_role.iam_role_ecs_terraform.ecs_role.arn
  task_execution_role_policy     = module.aws_iam_role.iam_role_ecs_terraform.ecs_role.arn
