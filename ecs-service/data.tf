...
##################################################################
###ngdp-vut-dlake-dev-mas-iam-role##########
...
resource "aws_iam_policy" "pite-dldeb-Pull_image_dlake" {
  name = "pite-dldeb-Pull_image_dlake_${var.env}"
...
resource "aws_iam_policy" "pite-dldeb-infra-setup-policy" {
  name = "pite-dldeb-infra-setup-policy_${var.env}"
...
resource "aws_iam_policy" "pite-dldeb-pullfromecr" {
  name = "pite-dldeb-pullfromecr_${var.env}"
...
resource "aws_iam_policy" "pite-dldeb-aws-quicksetup-patchpolicy-baselineoverrides-s3_dlake" {
  name = "pite-dldeb-aws-quicksetup-patchpolicy-baselineoverrides-s3_dlake_${var.env}"
